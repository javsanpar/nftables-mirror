#!/usr/bin/python3
#
# (C) 2019 by Fernando Fernandez Mancera <ffmancera@riseup.net>
#
...
def write_signatures(osf_signatures, output):
	...
	for i, signature in enumerate(osf_signatures):
		...
		os_genre = input("Introduce the OS genre:\n")
		os_version = input("Introduce the OS version:\n")
		os_subtype = input("Introduce the OS subtype:\n")
		os_details = input("Introduce the OS details:\n")
